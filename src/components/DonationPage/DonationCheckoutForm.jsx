  ...
  useEffect(() => {
    ...
    stripe.retrievePaymentIntent(clientSecret).then(({ paymentIntent }) => {
      switch (paymentIntent.status) {
        case "succeeded":
          setMessage("Donation Payment succeeded!");
          break;
        case "processing":
          setMessage("Your Donation payment is processing.");
          break;
        case "requires_payment_method":
          setMessage("Your Donation payment was not successful, please try again.");
          break;
        default:
